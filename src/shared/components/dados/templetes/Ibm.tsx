        ...
        >
            ...
            >
                <Box p={2}> {/* Conteúdo do menu lateral */}
                    <p> Ferramenta da IBM para análise avançada de dados e construção de modelos de machine learning. Oferece um ambiente colaborativo para cientistas de dados e analistas.</p>
