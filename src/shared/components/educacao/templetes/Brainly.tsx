        ...
        >
            ...
            >
                <Box p={2}> {/* Conteúdo do menu lateral */}
                    <p>Uma IA integrada ao Brainly, plataforma de perguntas e respostas.Auxilia estudantes a encontrar explicações detalhadas para suas dúvidas em diversas matérias. Oferece respostas personalizadas, ajudando no aprendizado autônomo.
                    </p>
