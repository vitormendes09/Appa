        ...
        >
            ...
            >
                <Box p={2}> {/* Conteúdo do menu lateral */}
                    <p>Plataforma de aprendizado adaptativo que personaliza os conteúdos para cada aluno. Usa IA para analisar o progresso dos estudantes e sugerir materiais adicionais. Ajuda professores a identificarem dificuldades e ajustarem a metodologia de ensino.
                    </p>
