        ...
        >
            ...
            >
                <Box p={2}> {/* Conteúdo do menu lateral */}
                    <p> Desenvolvida para ajudar professores a corrigirem provas e tarefas automaticamente. Suporta respostas escritas à mão e questões de múltipla escolha.Usa IA para identificar padrões de erros e melhorar a avaliação do aprendizado.
                    </p>
