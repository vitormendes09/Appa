	...
	return (
		...
		<Card sx={{ width: 300, height: "10rem" ,borderRadius: "8px", overflow: "hidden", boxShadow: 3 }}>
			...
			<CardMedia
				...
				image={`${process.env.PUBLIC_URL}/cards/Quizlet_logo.png`}
				alt="Logo Quizlet"
				sx={{
			...
			<Drawer
						...
						>
							<Box p={2}> {/* Conteúdo do menu lateral */}
								<p>Plataforma educacional com IA que gera flashcards, quizzes e resumos de conteúdos. Ajuda alunos a estudar de forma eficiente com testes interativos e revisão espaçada.</p>
