	...
	return (
		...
		<Card sx={{ width: 300,height: "10rem" , borderRadius: "8px", overflow: "hidden", boxShadow: 3 }}>
			...
			<CardMedia
				...
				image={`${process.env.PUBLIC_URL}/cards/gemini_logo.webp`}
				alt="Logo Gemine"
				sx={{
			...
			>
				...
				<IconButton
					...
					onClick={handleMenuClick}
					component="a"
                    href="gemini.google.com/?hl=pt-BR"
                    target="_blank"
			...
			<Drawer
						...
						>
							<Box p={2}> {/* Conteúdo do menu lateral */}
								<p>Integrado ao Google Workspace, oferece processamento multimodal avançado e análise visual.</p>
