			...
			<Drawer
						...
						>
							<Box p={2}> {/* Conteúdo do menu lateral */}
								<p> IA que analisa tendências e prevê quais anúncios terão melhor desempenho antes mesmo de serem lançados. Recomenda ajustes em cores, textos e elementos visuais para maximizar conversões.</p>
