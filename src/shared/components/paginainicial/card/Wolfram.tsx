	...
	return (
		...
		<Card sx={{ width: 300, height: "10rem" ,borderRadius: "8px", overflow: "hidden", boxShadow: 3 }}>
			...
			<CardMedia
				...
				image={`${process.env.PUBLIC_URL}/cards/Wolfram_logo.png`}
				alt="Logo Dall-E"
				sx={{
			...
			<Drawer
						...
						>
							<Box p={2}> {/* Conteúdo do menu lateral */}
								<p> IA especializada em resolver problemas matemáticos, estatísticos e científicos. Analisa equações, gera gráficos, calcula probabilidades e responde questões de ciências exatas.</p>
