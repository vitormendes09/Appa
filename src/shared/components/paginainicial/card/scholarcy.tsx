...
export const Scholatcy: React.FC = () => {
			...
			<Drawer
						...
						>
							<Box p={2}> {/* Conteúdo do menu lateral */}
								<p>Ferramenta de resumo automático de artigos e livros acadêmicos. Extrai os pontos principais e cria resumos estruturados para facilitar o entendimento.  Gera citações e destaca informações importantes para estudos.</p>
