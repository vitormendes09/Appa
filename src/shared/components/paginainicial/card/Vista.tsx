	...
	return (
		...
		<Card sx={{ width: 300, height: "10rem" , borderRadius: "8px", overflow: "hidden", boxShadow: 3 }}>
			...
			<CardMedia
				...
				image={`${process.env.PUBLIC_URL}/cards/Vista_logo.webp`}
				alt="Logo Gemine"
				sx={{
			...
			>
				...
				<IconButton
					...
					onClick={handleMenuClick}
					component="a"
                    href="https://vistasocial.com/?gloptid=CjsaCQiAqsitBhDlARIsAGMR1RixghUmewbascB&bbae=vanrpopo&zmuium=vaollasop2&abergn=gacase3da&opent=ikbaorte&fpr=sergei99&ga2as=bkmopikulop&gad_source=1&gclid=CjwKCAiAiaC-BhBEEiwAjY99qN5mEfHbpctKMdkhzyGTqe6JFHGbh5mg40SGdJrvO83H-184Ug4fFxoC3_sQAvD_BwE"
                    target="_blank"
            ...
            <Box p={2}> {/* Conteúdo do menu lateral */}
                        <p>Plataforma de agendamento e otimização de conteúdo, com geração automática de postagens baseadas em tendências.</p>
