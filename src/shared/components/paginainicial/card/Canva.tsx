		...
		<Card sx={{ width: 300, height: "10rem" , borderRadius: "8px", overflow: "hidden", boxShadow: 3 }}>
			...
			>
				...
				<IconButton
					...
					onClick={handleMenuClick}
					component="a"
                    href="https://www.canva.com/pt_pt/ferramentas/gerador-imagem-ia/"
                    target="_blank"
			...
			<Drawer
                        ...
                        >
                            <Box p={2}> {/* Conteúdo do menu lateral */}
                                <p>Oferece ferramentas automatizadas para criação de posts, stories e materiais gráficos otimizados para redes sociais.</p>
