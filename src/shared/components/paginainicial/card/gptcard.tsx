    ...
    <Card sx={{ width: 300, height: "10rem", borderRadius: "8px", overflow: "hidden", boxShadow: 3 }}>
      ...
      >
        <Box p={2}> {/* Conteúdo do menu lateral */}
          <p>Assistente de linguagem natural desenvolvido pela OpenAI, capaz de gerar textos, responder perguntas e auxiliar em diversas tarefas.</p>
