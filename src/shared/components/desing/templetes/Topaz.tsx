        ...
        >
            <Card sx={{ width: 300, height: "10rem", borderRadius: "8px", overflow: "hidden", boxShadow: 3, textAlign: "center" }}>
                <CardMedia
                    ...
                    image={`${process.env.PUBLIC_URL}/templetes/Topaz_logo.jpg`}
                    alt="Logo Topaz"
                    sx={{
            ...
            >
                ...
                <IconButton
                    component="a"
                    href="https://www.topazlabs.com/?srsltid=AfmBOoqYieVxrjM178ZN5i1lWwDexS26C3MB61XCLSNxVg6AsBWCixOx"
                    target="_blank"
            ...
            >
                <Box p={2}> {/* Conteúdo do menu lateral */}
                    <p>IA para aprimoramento de imagens, redução de ruído e upscaling de fotos.</p>
